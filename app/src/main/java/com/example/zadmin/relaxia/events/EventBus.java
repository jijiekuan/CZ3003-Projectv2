...
public class EventBus {
    ...
    public void notify(Event event) {
        Log.i(TAG, "Inside notify method, " + " Event: "+ event.getType());
        synchronized (obj) {
            List<EventObserver> observers = events.get(event.getType()); //get this list of EventObservers of event type
            //Log.i(TAG, "Observers: " + observers.toString());
            //Somehow inside observers, there are 4 engines running instead of 1. Thats why 4 events get fired each time. Why?
