...
public class CTDDifficultySelectFrag extends Fragment {
    @Override
    ...
    private void setOnClick(View view, final int difficulty) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Shared.eventBus.notify(new ConnectDotsDifficultySelectedEvent(difficulty));
            }
        });
    }
}
